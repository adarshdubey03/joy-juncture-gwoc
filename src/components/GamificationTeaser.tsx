export default function GamificationTeaser() {
  return (
    <section className="w-full bg-[#FFF4D6] py-20 md:py-32">
      <div className="mx-auto max-w-360 px-6 md:px-8 flex flex-col">
        ...
        <div className="relative w-full h-[40vh] md:h-[90vh] rounded-4xl overflow-hidden bg-white shadow-xl">
          <iframe
        ...
        <p className="mt-8 md:mt-10 text-xs md:text-sm text-neutral-500 text-center max-w-xl mx-auto">
