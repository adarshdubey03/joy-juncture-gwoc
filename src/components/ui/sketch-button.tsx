...
export function SketchButton({ text = "Shop Games", className, ...props }: SketchButtonProps) {
    return (
        <div className={`align-middle inline-flex ${className || ''}`}>
            <div>
                <button className="sketch-button" {...props}>
